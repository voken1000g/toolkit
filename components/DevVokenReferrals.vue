<template>
  <div class="py-16 lg:py-24">
    <div class="resp-wide">
      ...
      <div v-if="records.length" class="mt-12">
        <layout-table-simple>
          <table>
            <thead>
            <tr>
...
<!--              <td>-->
<!--                <a target="_blank" :href="fnEtherscan.address(record.referrer)">-->
<!--                  {{ record.referrer }}-->
<!--                </a>-->
<!--              </td>-->
              <td>
      ...
      if (events.length > 0) {
        ...
        for (let i = 0; i < events.length; i++) {
          records.unshift({
            ...
            referrer: events[i].returnValues.referrerAccount,
            payment: null,
            referrals: null,
            reward: null
          })
