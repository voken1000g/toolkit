<template>
  <button :class="{ 'bg-indigo-600 border-transparent': isOn, 'bg-gray-200 border-gray-300': !isOn }"
          class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:shadow-outline"
  >
